  ...
  sqlstr:=' select DISTINCT os.id,'+
    ...
    begin
      ...
      begin
        ...
        if ConsultaSqlFd(qry,sqlstr)  then
        begin
          semregistros;
          edtnome.SetFocus;
        end
