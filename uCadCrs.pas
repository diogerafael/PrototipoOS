...
begin
  inherited;
  if Obrigatorio(Self,edtdesc,'Inserir Descriçao do CRS !') then Exit;
...
begin
  inherited;
  if Obrigatorio(Self,edtdesc,'Inserir Descrição do CRS !') then Exit;
  ...
  begin
    Application.MessageBox('CRS Já Cadastrado !', 'Atenção', MB_OK +
      MB_ICONINFORMATION);
      Exit;
  end;
