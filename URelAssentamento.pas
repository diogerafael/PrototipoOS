...
begin
  inherited;
  if edtini.Text='' then begin Application.MessageBox('Informar Data Inicial !','Atenção', MB_OK + MB_ICONINFORMATION); Exit;end;

  if edtfim.Text='' then begin Application.MessageBox('Informar Data Final !','Atenção', MB_OK + MB_ICONINFORMATION); Exit;end;
...
begin
  ...
  begin
    ...
    rdprnt1.impf(03,01,'RELATÓRIO DE ASSENTAMENTOS',[comp17,negrito]);
    rdprnt1.imp(04,01,_traco137);

    rdprnt1.impf(05,01,'CÓDIGO',[comp17,negrito]);
    rdprnt1.impf(05,20,'DATA',[comp17,negrito]);
    rdprnt1.impf(05,35,'DESCRIÇÃO',[comp17,negrito]);
...
procedure TFrmRelAssentamento.FormShow(Sender: TObject);
begin
  inherited;
